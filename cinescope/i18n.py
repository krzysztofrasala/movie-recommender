...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "PL": {
        ...
        # Assistant
        "assistant_title": "💬 Asystent AI Filmowy",
        "assistant_subtitle": "Porozmawiaj z wirtualnym doradcą, który pomoże Ci znaleźć idealny film lub serial!",
        "clear_chat": "🗑️ Wyczyść czat",
        "chat_input_placeholder": "Napisz jakiego filmu lub serialu dzisiaj szukasz...",
        "chat_welcome_msg": "Cześć! Jestem Twoim wirtualnym doradcą filmowym i serialowym. Jakiego gatunku lub klimatu dzisiaj szukasz?",
    },
    "EN": {
        "app_title": "🎬 CineScope",
